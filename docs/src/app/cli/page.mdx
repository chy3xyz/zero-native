...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>zero-native plugins list</code></td>
      <td>List all 11 bundled plugins (id, name, description)</td>
    </tr>
    <tr>
      <td><code>zero-native plugins info &lt;name&gt;</code></td>
      <td>Show a single plugin's ModuleId, capability kind, and usage example</td>
    </tr>
    <tr>
      <td><code>zero-native plugins create &lt;name&gt;</code></td>
      <td>Scaffold a new <code>plugin_&lt;name&gt;.zig</code> file in the current directory</td>
    </tr>
    <tr>
      <td><code>zero-native updater sign|verify</code></td>
      <td>Ed25519 sign / verify files for the auto-updater (base64 keys)</td>
    </tr>
    <tr>
      <td><code>zero-native audit [app.zon]</code></td>
      <td>Check the manifest against production-readiness best practices</td>
    </tr>
    <tr>
